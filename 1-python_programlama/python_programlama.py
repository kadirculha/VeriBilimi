...
#pop elemaan çıkkaarır yeniden atamaya gerek yok
...
#count o elemandan kaç tane var
...
t = ("eleman",)#tek elemanlı tuple oluşturmak için sona bir virgül
type(t)
...
# Veri Yapıları - Dictionary (Sözlük) kapsayıcı- sıarasız  değiştirilebilir
...
sozluk[l] = "yeni bir sey" # sözlüklerde key değerleri sadece sabit veri yapıları ile oluşturulur
...
#Veri Yapilari - Setler (küme) sırasızdır - eşsiz -değiştirilebilir hızlıdır
...
#map & filter & reduce ##nnesnenin üzerine fonksiyonu uygular
